...
SELECT aluno_nome, turma, nota FROM notas_alunos WHERE nota >= 70;

SELECT aluno_nome, turma, nota FROM notas_alunos WHERE disciplina = 'Matematica' AND nota >=50;

SELECT media_nota FROM (
    SELECT disciplina, AVG(nota) AS media_nota FROM notas_alunos GROUP BY disciplina
) AS teste
